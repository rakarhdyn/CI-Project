...
<section class="content">
    ...
    <?php endif; ?>
    <div class="container">
        <a href="/add_basket"><button type="submit" class="btn btn-info">+ Add New Basket</button></a>
    </div>
    <br>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="col-4">
                            <h2 class="card-title">Basket Table</h2>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($basket as $b) : ?>
                                        <tr>
                                            ...
                                            <td><a href="/basket/edit/<?= $b['id']; ?>"><i class="fas fa-edit"></i></a></td>
                                            <td><a href="basket/delete/<?= $b['id']; ?>" onclick="return confirm('apakah anda ingin menghapus data ini?')"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
                            </table>
                            <?= $pager->links('basket', 'pk_pagination'); ?>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
